...
export default memo(function Card({index, movieData, isLiked}){
  ...
  return(
    <Container onMouseEnter={()=>setIsHovered(true)} onMouseLeave={()=>setIsHovered(false)}>
      <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="movieImg"/>
      {isHovered && (
        <div className="hover">
          <div className="image-video-container">
            <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="movieImg" onClick={()=>navigate("/player")}/>
          ...
          <div className="info-container flex column">
            ...
            <div className="icons flex j-between">
              ...
              <div className="info">
                <BiChevronDown title="More Information"/>
              </div>
            </div>
